...
%
\authorrunning{S. Gerber et al.} % abbreviated author list (for running head)
%
...
retina. A diameter of the optic nerve greater than 5\,mm indicates increased
...
steps illustrated in Figure~\ref{fig:algorithm-eye}.  
\begin{figure}
\centering
\begin{tabular}{ccccc}
\includegraphics[height=1.2in]{019.png} &
\includegraphics[height=1.2in]{019-eye-smooth.png} &
\includegraphics[height=1.2in]{019-eye-distance.png} &         
\includegraphics[height=1.2in]{019-eye-moving.png} &
\includegraphics[height=1.2in]{019-overlay.png}\\
(a) & (b) & (c) & (d) & (e)
\end{tabular}
\caption{
...
registered ellipse and optic nerve sheath overlayed on the input image.
}
\end{figure}
...
have strong intensity variations.  We propose several image processing steps,
illustrated in Figure~\ref{fig:algorithm-nerve}, to enhance the shadow boundary
before a registration of two parallel vertical bars to delineate the width of
the shadow.
\begin{figure}
\centering
\begin{tabular}{cccccc}
\includegraphics[height=0.39in]{019-nerve.png} &
\includegraphics[height=0.39in]{019-nerve-smooth.png} &
\includegraphics[height=0.39in]{019-nerve-distance.png} &
\includegraphics[height=0.39in]{019-nerve-scaled.png} &
\includegraphics[height=0.39in]{019-nerve-thres.png} &         
\includegraphics[height=0.39in]{019-nerve-moving.png} \\         
(a) & (b) & (c) & (d) & (e) & (f)
\end{tabular}
\caption{
...
center (e) thresholding and (f) vertical bars before registration based on initial
estimates.
}
\end{figure}
...
\item Refine initial center and width estimates:
  ...
  \item Binary threshold, morphological opening and distance transform.
  \end{enumerate}
\item Use refined center and width to create an image with two vertical bars. 
...
\centering
\begin{tabular}{cc}
  \includegraphics[height=0.3\linewidth]{gui.jpg} &
\includegraphics[height=0.3\linewidth]{OpticNerveUISreenshot.png} \\
(a) & (b)
\end{tabular}
\caption{
\label{fig:gui}
...
\end{tabular}
\end{table}
The standard deviations of the individual measurements per disc are
too large to accurately suggest elevated intracranial pressure. However, the
mean deviation of the mean estimates from the ground truth over the 5
measurements is only 0.2\,mm with a standard deviation of 0.18\,mm.  This suggest
that the means reported by the automatic estimation procedure measurements are
accurate enough to determine elevated intracranial pressure. In this small
study the proposed algorithm yields more accurate results than reported in a
study on intra-operator variations of manual estimates on the same type of
phantom, but with higher resolution ultrasound probes, reports an
average bias of 0.33\,mm and standard deviations of 0.64\,mm of the
...
when a sufficient number of high quality images have been acquired for an
accurate estimate of the diameter. Based on this estimate it will be able to
automatically indicate if the diameter of the optic nerve is greater than 5\,mm
and alert the user elevated intracranial pressure.
